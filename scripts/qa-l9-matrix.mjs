...
const CREDIT_EXPECTATIONS = {
  ...
  colectivos: /API Transporte|Buenos Aires/i,
  'conae-fires': /CONAE/i,
  'edesur-outages': /Edesur/i,
  'fuel-prices': /Energía|surtidor/i,
  'local-pba-comisarias': /Seguridad|Buenos Aires/i,
  'local-tren-estaciones': /IDE Transporte|ferroviarias|Provincia de Buenos Aires/i,
  subte: /Mapa Interactivo BA|Buenos Aires Ciudad/i,
  'puerto-ba': /AGP|Puerto de Buenos Aires/i,
  'aire-caba': /APrA/i,
  'local-ba-salud': /Mapa Interactivo BA|Provincia de Buenos Aires/i,
  'local-ba-bomberos': /Mapa Interactivo BA|Provincia de Buenos Aires/i,
  'local-caba-servicios': /Mapa Interactivo BA/i,
  'local-renabap-amba': /RENABAP/i,
  'local-caba-ciclovias': /Buenos Aires Ciudad/i,
  'local-laplata-inundacion': /La Plata/i,
  'caba-ruido': /USIG/i,
  'caba-hidrica': /USIG/i,
  'caba-fotos-aereas': /USIG/i,
  'caba-tematico': /USIG/i,
  'local-pba-escuelas': /Provincia de Buenos Aires/i,
  'local-pba-terminales': /IDEBA/i,
  'local-mdp-paradas': /General Pueyrred/i,
  'local-mdp-recorridos': /General Pueyrred/i,
  'local-pozos-hidrocarburos': /Neuquén|hidrocarburos/i,
  'local-prov-salud': /IDEs provinciales/i,
  'local-prov-seguridad': /IDEs provinciales/i,
  'local-escuelas-argentina': /Mapa Educativo/i,
  'smn-alerts': /Servicio Meteorológico|SMN/i,
  'ina-rivers': /Instituto Nacional del Agua|INA/,
  'rutas-estado': /Vialidad|rutas\.ar/i,
  'smn-weather': /Servicio Meteorol|SMN/i,
  'cammesa-grid': /CAMMESA/i,
  'local-caba-radares': /Buenos Aires Ciudad|data\.buenosaires/i,
  'rainviewer-radar': /RainViewer/i,
