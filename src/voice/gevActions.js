...
const LAYER_ALIASES = new Map([
  ...
  ['weather stations', 'smn-weather'],
  ['clima', 'smn-weather'],
  ['smn', 'smn-weather'],
  ['power grid', 'cammesa-grid'],
  ['electricity', 'cammesa-grid'],
  ['cammesa', 'cammesa-grid'],
  ['red electrica', 'cammesa-grid'],
  ['speed cameras', 'local-caba-radares'],
  ['fotomultas', 'local-caba-radares'],
  ['radares', 'local-caba-radares'],
  ['fires', 'conae-fires'],
  ['hotspots', 'conae-fires'],
  ['focos de calor', 'conae-fires'],
  ['incendios', 'conae-fires'],
  ['outages', 'edesur-outages'],
  ['cortes de luz', 'edesur-outages'],
  ['edesur', 'edesur-outages'],
  ['fuel prices', 'fuel-prices'],
  ['gas stations', 'fuel-prices'],
  ['nafta', 'fuel-prices'],
  ['estaciones de servicio', 'fuel-prices'],
  ['police stations', 'local-pba-comisarias'],
  ['comisarias', 'local-pba-comisarias'],
  ['train stations', 'local-tren-estaciones'],
  ['estaciones de tren', 'local-tren-estaciones'],
  ['weather alerts', 'smn-alerts'],
  ['alertas', 'smn-alerts'],
  ['alertas meteorologicas', 'smn-alerts'],
  ['road status', 'rutas-estado'],
  ['estado de rutas', 'rutas-estado'],
  ['rutas', 'rutas-estado'],
  ['cortes de ruta', 'rutas-estado'],
  ['subte', 'subte'],
  ['subway', 'subte'],
  ['metro', 'subte'],
  ['puerto', 'puerto-ba'],
  ['port', 'puerto-ba'],
  ['barcos en el puerto', 'puerto-ba'],
  ['calidad de aire', 'aire-caba'],
  ['air quality', 'aire-caba'],
  ['hospitales', 'local-ba-salud'],
  ['hospitals', 'local-ba-salud'],
  ['bomberos', 'local-ba-bomberos'],
  ['fire stations', 'local-ba-bomberos'],
  ['farmacias', 'local-caba-servicios'],
  ['servicios', 'local-caba-servicios'],
  ['barrios populares', 'local-renabap-amba'],
  ['renabap', 'local-renabap-amba'],
  ['ciclovias', 'local-caba-ciclovias'],
  ['bike lanes', 'local-caba-ciclovias'],
  ['inundacion', 'local-laplata-inundacion'],
  ['flood risk', 'local-laplata-inundacion'],
  ['ruido', 'caba-ruido'],
  ['noise map', 'caba-ruido'],
  ['arroyos', 'caba-hidrica'],
  ['fotos aereas', 'caba-fotos-aereas'],
  ['aerial photos', 'caba-fotos-aereas'],
  ['historical imagery', 'caba-fotos-aereas'],
  ['mapas tematicos', 'caba-tematico'],
  ['thematic maps', 'caba-tematico'],
  ['escuelas', 'local-pba-escuelas'],
  ['schools', 'local-pba-escuelas'],
  ['terminales', 'local-pba-terminales'],
  ['peajes', 'local-pba-terminales'],
  ['toll plazas', 'local-pba-terminales'],
  ['paradas mar del plata', 'local-mdp-paradas'],
  ['recorridos mar del plata', 'local-mdp-recorridos'],
  ['mar del plata buses', 'local-mdp-recorridos'],
  ['pozos', 'local-pozos-hidrocarburos'],
  ['pozos de petroleo', 'local-pozos-hidrocarburos'],
  ['oil wells', 'local-pozos-hidrocarburos'],
  ['vaca muerta', 'local-pozos-hidrocarburos'],
  ['salud provincias', 'local-prov-salud'],
  ['hospitales provincias', 'local-prov-salud'],
  ['comisarias provincias', 'local-prov-seguridad'],
  ['bomberos provincias', 'local-prov-seguridad'],
  ['escuelas argentina', 'local-escuelas-argentina'],
  ['escuelas provincias', 'local-escuelas-argentina'],
  ['hidrologia', 'caba-hidrica'],
  ['rivers', 'ina-rivers'],
  ['river levels', 'ina-rivers'],
  ['rios', 'ina-rivers'],
  ['alturas de rios', 'ina-rivers'],
  ['inundaciones', 'ina-rivers'],
  ['rain radar', 'rainviewer-radar'],
  ['weather radar', 'rainviewer-radar'],
  ['precipitation', 'rainviewer-radar'],
  ['rainviewer', 'rainviewer-radar'],
  ['radar de lluvia', 'rainviewer-radar'],
