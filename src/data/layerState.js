...
export const LAYER_STATE_REGISTRY = Object.freeze([
  ...
  Object.freeze({ id: 'caba-fotos-aereas', token: 'b4', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'caba-tematico', token: 'b5', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'conae-fires', token: 'l', disposition: 'enabled-only' }),
  Object.freeze({ id: 'earthquakes', token: 'e', disposition: 'enabled-only' }),
  Object.freeze({ id: 'edesur-outages', token: 'y', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'local-escuelas-argentina', token: 'c4', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'local-mdp-paradas', token: 'b6', disposition: 'enabled-only' }),
  Object.freeze({ id: 'local-mdp-recorridos', token: 'b7', disposition: 'enabled-only' }),
  Object.freeze({ id: 'local-pba-comisarias', token: 'h', disposition: 'enabled-only' }),
  Object.freeze({ id: 'local-pba-escuelas', token: 'b8', disposition: 'enabled-only' }),
  Object.freeze({ id: 'local-pba-terminales', token: 'b9', disposition: 'enabled-only' }),
  Object.freeze({ id: 'local-pozos-hidrocarburos', token: 'c1', disposition: 'enabled-only' }),
  Object.freeze({ id: 'local-prov-salud', token: 'c2', disposition: 'enabled-only' }),
  Object.freeze({ id: 'local-prov-seguridad', token: 'c3', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'rutas-estado', token: '2', disposition: 'enabled-only' }),
