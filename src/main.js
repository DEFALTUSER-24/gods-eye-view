...
import smnWeatherLayer from './data/smnWeather.js';
import cammesaGridLayer from './data/cammesaGrid.js';
...
import smnAlertsLayer from './data/smnAlerts.js';
import rutasEstadoLayer from './data/rutasEstado.js';
import inaRiversLayer from './data/inaRivers.js';
import rainviewerLayer from './data/rainviewer.js';
...
async function init() {
  ...
  try {
    ...
    dataManager.register(colectivosLayer);
    dataManager.register(smnWeatherLayer);
    dataManager.register(cammesaGridLayer);
    dataManager.register(rainviewerLayer);
    dataManager.register(conaeFiresLayer);
    dataManager.register(edesurOutagesLayer);
    dataManager.register(fuelPricesLayer);
    dataManager.register(smnAlertsLayer);
    dataManager.register(rutasEstadoLayer);
    dataManager.register(subteLayer);
    dataManager.register(puertoBaLayer);
