...
| **RENABAP 2020** (geoportal.obraspublicas.gob.ar WFS, bundled AMBA subset) | Barrios populares layer (1 200 polygons) | Public national registry | "RENABAP — Ministerio de Obras Públicas" |
...
| **USIG mapcache WMS** (tiles1.usig.buenosaires.gob.ar) | Mapa de ruido CABA and Arroyos y cuencas CABA imagery layers | Public city geoservice | "USIG — Buenos Aires Ciudad" |
