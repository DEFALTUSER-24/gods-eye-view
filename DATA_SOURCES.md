...
| **Buenos Aires Ciudad — epok (Mapa Interactivo BA backend)** (live: subte; bundled: salud, bomberos, servicios) | Subte layer (stations + lines with live `Estado`), Salud pública BA, Bomberos BA, Servicios CABA (farmacias, cajeros, taxis, terminales, antenas, museos, wifi) | Public city map service, CC-BY GCBA | "Mapa Interactivo BA — Buenos Aires Ciudad" |
